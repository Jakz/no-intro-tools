...
import com.github.jakz.nit.data.header.Rule;
import com.github.jakz.nit.data.header.Test;
import com.github.jakz.nit.data.header.TestData;
...
public class HeaderParser extends XMLHandler<Header>
{
  ...
  @Override protected void start(String ns, String name, Attributes attr)
  {
